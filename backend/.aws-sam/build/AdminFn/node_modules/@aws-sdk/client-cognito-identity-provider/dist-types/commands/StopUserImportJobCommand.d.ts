...
declare const StopUserImportJobCommand_base: {
    new (input: StopUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<StopUserImportJobCommandInput, StopUserImportJobCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopUserImportJobCommandInput): import("@smithy/core/client").CommandImpl<StopUserImportJobCommandInput, StopUserImportJobCommandOutput, import("..").CognitoIdentityProviderClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
